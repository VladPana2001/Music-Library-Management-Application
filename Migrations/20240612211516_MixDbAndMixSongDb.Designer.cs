...
namespace Music_Library_Management_Application.Migrations
{
    ...
    [Migration("20240612211516_MixDbAndMixSongDb")]
    partial class MixDbAndMixSongDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Music_Library_Management_Application.Models.DbModels.MixDb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("LimiterThreshold")
                        .HasColumnType("float");

                    b.Property<byte[]>("MixFile")
                        .IsRequired()
            ...
            modelBuilder.Entity("Music_Library_Management_Application.Models.DbModels.MixSongDb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Music_Library_Management_Application.Models.DbModels.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Music_Library_Management_Application.Models.DbModels.MixSongDb", b =>
                {
                    b.HasOne("Music_Library_Management_Application.Models.DbModels.MixDb", "MixDb")
                        .WithMany("MixSongs")
                        .HasForeignKey("MixDbId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
